Feature: Portal
  ...
  Background:
    ...
    Given the token on the level's board at (1, 3) should be a Portal token
  ...
  Scenario: Teleport through the Blue opening
    Given the token on the level's board at (2, 1) should be a Portal token
  ...
  Scenario: Teleport through the Red opening
    Given the token on the level's board at (2, 1) should be a Portal token
    When I turn the given token in the level to face up
  ...
  Scenario: Teleportation through non-opening side of the portal
    Given the token on the level's board at (2, 1) should be a Portal token
    When I turn the given token in the level to face right
